...
name: jfox-bookshelf
description: |
  Manage books on the jfox bookshelf—add a book (PDF + scan2book-extracted bundle),
  list books, view a book's metadata or a specific page, or remove a book.
  Triggers on: "书架", "bookshelf", "加书", "导入书", "看书 page", "书 页",
  "manage books", "add book to shelf", "list books", "remove book".
---
